...
tarin_p = clf.predict(test[columns])
tarin2_p = clf2.predict(test[columns])

print(roc_auc_score(test["high_income"], tarin_p))
print(roc_auc_score(test["high_income"], tarin2_p))
...
f =  (predictions + predictions2)/2

f = numpy.round(f)
print(roc_auc_score(test["high_income"], f))
